...
public class SucursalController {
    ...
    public void obtenerSucursales(SucursalModel sucursal, SucursalController.VolleyResponseListener volleyResponseListener){
        url = "https://udbdsmapi.000webhostapp.com/api/sucursal/getSucursales";
        JSONObject datos = new JSONObject();
        try{
            datos.put("userId",null);
