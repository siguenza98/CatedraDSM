...
public class ServicioController {
    ...
    public void obtenerServicios(SucursalController.VolleyResponseListener volleyResponseListener){
        url = "https://udbdsmapi.000webhostapp.com/api/servicios/getServicios";
